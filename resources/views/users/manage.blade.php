        ...
        <div class="col-12">
            <div class="card mb-6">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">{{ !empty($data) ? "Edit" : "Add" }} User</h5>
                        ...
                        <div class="row g-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    ...
                                    <div class="form-text">* Leave the password field blank if you don't want to change it.</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    ...
                                    <div class="error-confirm_password invalid-feedback mx-3"></div>
                                    <div class="form-text">* Enter your password again.</div>
                                </div>
                            </div>
                            @if(!empty($data))
                            <div class="col-md-6">
