...
<html lang="en" class="light-style layout-wide customizer-hide" dir="ltr" data-theme="theme-default"
    data-assets-path="{{ url('assets') }}/" data-template="vertical-menu-template" data-style="light">
...
<head>
    ...
    @include('auth.layout.helper-js')
</head>

<body>
    <div class="authentication-wrapper authentication-cover">
        <a href="{{ __settings('SITE_BACK_URL') }}" class="auth-cover-brand d-flex align-items-center gap-2">
            ...
            <span class="app-brand-text demo text-heading fw-semibold">{{ __settings('SITE_TITLE') }}</span>
        </a>
